    ...
    <div class="container-fluid">
        <div class="row-fluid">
            ...
            <div class="span8">
                <div class="hero-unit">
                	<?php if(isset($_SESSION['is_login']) && $_SESSION['is_login'] == true):?>
				        <a href="php/articleadd.php" class="btn btn-primary btn-xs pull-right">文章新增<span class="glyphicon glyphicon-plus"></span></a><br>
				    <?php else:?>
				    	<a href="php/memberlogin.php" class="btn btn-primary btn-xs pull-right">文章新增<span class="glyphicon glyphicon-plus"></span></a><br>
                    <?php endif;?>
                    <?php if(!empty($article)):?>
					    ...
					    <?php
					   	...
					   	?>  
                            ...
                            <div class="panel-heading"><a href="show_article.php?p=<?php echo $row['id'];?>"><font face='微軟正黑體'><?php echo $row['title'];?></font></a></div>
                                <div class="panel-body">
                                    <span class="label label-info"><?php echo $row['category'];?></span>
                                    <span class="label label-warning"><?php echo $row['publishdate'];?></span>
                                    <pre><?php echo $str . "...";?><a href="show_article.php?p=<?php echo $row['id'];?>">more</a></pre>
                                </div>
                            </div>
                    <?php endforeach;?>
				    <?php else:?>
