				...
				<div class="row">
					<div class="col-xs-12">
                        ...
                        <ul class="nav nav-pills">
                            ...
                            <li role="presentation" class="active"><a href="communication.php">討論區管理</a></li>
					    	...
					    	<table class="table table-hover">
                                ...
                                <?php foreach($data as $row):?>
					        	    <tr>
                                    	...
                                    	<td><?php echo $row['createusername']?></td>
                                    	<td><?php echo $row['imagepath']?></td>
                                    	<td><?php echo $row['publishdate']?></td>
                                	    <td>
                                		    <a href="article_del.php?id=<?php echo $row['id']  ?>" class="del">刪除</a>
                                	    </td>
                                    </tr>
                                <?php endforeach;?>
                            </table>
